...
| **Task 2b** — Seat & user queries (`query_available_seats`, `query_user_profile`, `query_user_bookings`, `query_payment_info`)                               | 王若琳 (michellewm20) | 蘇晏婷                     | Covers both national rail and metro history                                                  |
