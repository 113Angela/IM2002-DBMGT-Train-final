...
|-----------|-----------|----------------|-------|
| [Angela's full name] | [Angela's student ID] | 113Angela | [Angela's email] |
| [Kiki's full name] | [Kiki's student ID] | kiisu950626 | [Kiki's email] |
| 王若琳 | 1134034 | michellewm20 | [Michelle's email] |
...
|------|--------------|---------------------|-------|
| **Task 1** — Relational schema design (`schema.sql`) | 王若琳 (michellewm20) | [Kiki] | Schema designed based on all mock data JSON files |
...
| **Task 3** — PostgreSQL seeding (`seed_postgres.py`) | [Kiki] | 王若琳 (michellewm20) | Idempotent seeding with ON CONFLICT DO NOTHING |
| **Task 4** — Neo4j graph design & seeding (`seed_neo4j.py`, `seed.cypher`) | [Angela] | — | MetroStation, NationalRailStation nodes; METRO_LINK, RAIL_LINK, INTERCHANGE_TO relationships |
| **Task 5** — Neo4j query functions (`graph/queries.py`) | [Angela] | — | Shortest path, cheapest route, interchange path, delay ripple |
...
|---------|--------------|---------------------|-------|
| Section 1 — ER Diagram | [Angela] | — | Designed using ERD tools |
| Section 2 — Normalisation Justification | 王若琳 (michellewm20) | — | Based on schema design decisions |
| Section 3 — Graph Database Design Rationale | [Angela] | — | Neo4j node/relationship design |
| Section 4 — Vector / RAG Design | 王若琳 (michellewm20) | — | ChromaDB + policy document indexing |
...
|--------|-----------|---------------------|
| [Angela] | 34% | ERD design, Neo4j graph design, Neo4j query functions, graph seeding |
| [Kiki] | 33% | PostgreSQL seeding, data loading, schema support |
...
|--------|--------------|-------------|--------|
| Schema design | Originally assigned to 組員 A | Taken over by 組員 C (王若琳) | Needed to ensure compatibility with query functions |
...
|------|----------------------|------|
| [Angela's full name] | [Angela's full name] | 2026-06-12 |
| [Kiki's full name] | [Kiki's full name] | 2026-06-12 |
| 王若琳 | 王若琳 | 2026-06-12 |
